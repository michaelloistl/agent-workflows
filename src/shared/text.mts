...
// A branch-name slug from an issue/spec title: lowercase, non-alphanumerics folded
// to single hyphens, trimmed, capped at 40 chars. Shared by `implement`'s
// tracer-bullet branch (`agent/issue-<n>-<slug>`) and the orchestrator's spec
// branch (`agent/spec-<n>-<slug>`).
